...
foreach ($test in @('PlatformContract.Tests.ps1', 'SharedRuntime.Tests.ps1', 'AuthLogBoundary.Tests.ps1', 'RecoveryPhase.Tests.ps1', 'UpgradeFlow.Tests.ps1', 'ManagerBackupPlacement.Tests.ps1', 'ManagerSetupRetry.Tests.ps1')) {
